...
<p><a onclick="clearseo('Product Custom altss', '<?php echo $clearalts; ?>');" class="button" style="background:red">Clear Custom alts</a></p>
<p><a onclick="clearseo('Product Custom h1', '<?php echo $clearh1s; ?>');" class="button" style="background:red">Clear Custom h1</a></p>
