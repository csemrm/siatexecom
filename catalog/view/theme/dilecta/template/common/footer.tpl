...
<footer>
    ...
    <?php $grids = 12; $test = 0;  if($customfooter[$language_id]['aboutus_status'] == '1') { $test++; } if($customfooter[$language_id]['twitter_status'] == '1') { $test++; } if($customfooter[$language_id]['facebook_status'] == '1') { $test++; } if($customfooter[$language_id]['contact_status'] == '1') { $test++; }if($customfooter[$language_id]['contact2_status'] == '1') { $test++; } $grids = 12/$test; ?>
        ...
        <div class="set-size clearfix">
            ...
            <div class="grid-<?php echo $grids; ?> float-left"><div>
                    ...
                    <ul class="list-contact">
                        <?php if($customfooter[$language_id]['contact_address'] != '' ) { ?>
                        <li class="phone">
                            ...
                            <ul>
                                ...
                                <?php if($customfooter[$language_id]['contact_address'] != '') { ?>
                                <li<?php if($customfooter[$language_id]['contact_address'] == '') { echo ' style="padding-top:13px"'; } ?>><?php echo nl2br ( $customfooter[$language_id]['contact_address']); ?></li>
                                <?php } ?>
                        ...
                        <li class="skype">
                            ...
                            <ul>
                                ...
                                <li<?php if($customfooter[$language_id]['contact_phone2'] == '') { echo ' style="padding-top:13px"'; } ?>>Phone: <?php echo $customfooter[$language_id]['contact_phone']; ?></li>
                                <?php } ?>
                                <?php if($customfooter[$language_id]['contact_phone2'] != '') { ?>
                                <li<?php if($customfooter[$language_id]['contact_phone'] == '') { echo ' style="padding-top:13px"'; } ?>>Fax: <?php echo $customfooter[$language_id]['contact_phone2']; ?></li>
                                <?php } ?>
                        ...
                        <?php } ?>
                        <?php if(($customfooter[$language_id]['contact_skype'] != '' || $customfooter[$language_id]['contact_skype2'] != '')===2) { ?>
                        <li class="skype">
            ...
            <div class="grid-<?php echo $grids; ?> float-left"><div>
                    ...
                    <?php if($customfooter[$language_id]['contact2_title'] != '') { ?>
                    <h3 class="contact"><?php echo $customfooter[$language_id]['contact2_title']; ?></h3>
                    <?php } ?>

                    <ul class="list-contact">
                        <?php if($customfooter[$language_id]['contact2_address'] != '' ) { ?>
                        <li class="phone">
                            ...
                            <ul>
                                ...
                                <?php if($customfooter[$language_id]['contact2_address'] != '') { ?>
                                <li<?php if($customfooter[$language_id]['contact2_address'] == '') { echo ' style="padding-top:13px"'; } ?>><?php echo  nl2br ($customfooter[$language_id]['contact2_address']); ?></li>
                                <?php } ?>
                        ...
                        <?php } ?>
                        <?php if($customfooter[$language_id]['contact2_phone'] != '' || $customfooter[$language_id]['contact2_phone2'] != '') { ?>
                        <li class="skype">

                            <ul>

                                <?php if($customfooter[$language_id]['contact2_phone'] != '') { ?>
                                <li<?php if($customfooter[$language_id]['contact2_phone2'] == '') { echo ' style="padding-top:13px"'; } ?>>Phone: <?php echo $customfooter[$language_id]['contact2_phone']; ?></li>
                                <?php } ?>
                                <?php if($customfooter[$language_id]['contact2_phone2'] != '') { ?>
                                <li<?php if($customfooter[$language_id]['contact2_phone'] == '') { echo ' style="padding-top:13px"'; } ?>>Fax: <?php echo $customfooter[$language_id]['contact2_phone2']; ?></li>
                                <?php } ?>
                        ...
                        <?php } ?>
                        <?php if($customfooter[$language_id]['contact2_email'] != '' || $customfooter[$language_id]['contact2_email2'] != '') { ?>
                        <li class="email">

                            <ul>

                                <?php if($customfooter[$language_id]['contact2_email'] != '') { ?>
                                <li<?php if($customfooter[$language_id]['contact2_email2'] == '') { echo ' style="padding-top:13px"'; } ?>><?php echo $customfooter[$language_id]['contact2_email']; ?></li>
                                <?php } ?>
                                <?php if($customfooter[$language_id]['contact2_email2'] != '') { ?>
                                <li<?php if($customfooter[$language_id]['contact2_email'] == '') { echo ' style="padding-top:13px"'; } ?>><?php echo $customfooter[$language_id]['contact2_email2']; ?></li>
                                <?php } ?>
                        ...
                        <?php } ?>
                        <?php if(($customfooter[$language_id]['contact2_skype'] != '' || $customfooter[$language_id]['contact2_skype2'] != '')===2){ ?>
                        <li class="skype">

                            <ul>

                                <?php if($customfooter[$language_id]['contact2_skype'] != '') { ?>
                                <li<?php if($customfooter[$language_id]['contact2_skype2'] == '') { echo ' style="padding-top:13px"'; } ?>><?php echo $customfooter[$language_id]['contact2_skype']; ?></li>
                                <?php } ?>
                                <?php if($customfooter[$language_id]['contact2_skype2'] != '') { ?>
                                <li<?php if($customfooter[$language_id]['contact2_skype'] == '') { echo ' style="padding-top:13px"'; } ?>><?php echo $customfooter[$language_id]['contact2_skype2']; ?></li>
                                <?php } ?>
