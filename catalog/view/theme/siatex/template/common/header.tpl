...
<head>
	...
	<!-- CSS -->
	<link href="catalog/view/theme/siatex/css/stylesheet.css" rel="stylesheet" type="text/css" />
 	<link rel="stylesheet" type="text/css" href="catalog/view/theme/siatex/css/carousel.css" media="screen" />	
	<link rel="stylesheet" type="text/css" href="catalog/view/theme/siatex/css/slider/settings.css" media="screen" />
	<!-- Javascript -->
	<script type="text/javascript" src="catalog/view/theme/siatex/js/jquery-1.7.2.min.js"></script>
	<script type="text/javascript" src="catalog/view/theme/siatex/js/jquery.tweet.js"></script> 
	<script type="text/javascript" src="catalog/view/theme/siatex/js/slider/jquery.themepunch.plugins.min.js"></script>
	<script type="text/javascript" src="catalog/view/theme/siatex/js/slider/jquery.themepunch.revolution.min.js"></script>
	<script type="text/javascript">var rtl = <?php if($dir == 'rtl') { echo '1'; } else { echo '0'; } ?>;</script>
	<script type="text/javascript" src="catalog/view/theme/siatex/js/jquery-workarounds.js"></script>
	<script type="text/javascript" src="catalog/view/theme/siatex/js/jquery.jcarousel.min.js"></script>
	<script type="text/javascript" src="catalog/view/theme/siatex/js/jquery.flexslider-min.js"></script>
		
	<!-- Cloud Zoom -->
		
	<script src="catalog/view/theme/siatex/js/jquery.jqzoom-core.js" type="text/javascript"></script>
	<link rel="stylesheet" href="catalog/view/theme/siatex/css/jquery.jqzoom.css" type="text/css" />
	
	<!-- OPENCART JS -->
	<script type="text/javascript" src="catalog/view/theme/siatex/js/jquery/ui/jquery-ui-1.8.16.custom.min.js"></script>
	<link rel="stylesheet" type="text/css" href="catalog/view/theme/siatex/js/jquery/ui/themes/ui-lightness/jquery-ui-1.8.16.custom.css" />
	<script type="text/javascript" src="catalog/view/javascript/jquery/tabs.js"></script>
	<script type="text/javascript" src="catalog/view/javascript/jquery/colorbox/jquery.colorbox.js"></script>
	<link rel="stylesheet" type="text/css" href="catalog/view/javascript/jquery/colorbox/colorbox.css" media="screen" />
	<script type="text/javascript" src="catalog/view/javascript/jquery/ui/external/jquery.cookie.js"></script>
	
	<?php if($this->config->get('siatex_color') == '1') { ?>
	<link href="catalog/view/theme/siatex/css/color_2.css" rel="stylesheet" type="text/css" />
	<?php } ?>
	<?php if($this->config->get('siatex_color') == '2') { ?>
	<link href="catalog/view/theme/siatex/css/color_3.css" rel="stylesheet" type="text/css" />
	<?php } ?>
	<?php if($this->config->get('siatex_color') == '3') { ?>
	<link href="catalog/view/theme/siatex/css/color_4.css" rel="stylesheet" type="text/css" />
	<?php } ?>
	<?php if($this->config->get('siatex_color') == '4') { ?>
	<link href="catalog/view/theme/siatex/css/color_5.css" rel="stylesheet" type="text/css" />
	<?php } ?>
	<?php if($this->config->get('siatex_color') == '5') { ?>
	<link href="catalog/view/theme/siatex/css/color_1.css" rel="stylesheet" type="text/css" />
	<?php } ?>
	<?php if($dir == 'rtl') { ?>
	<link href="catalog/view/theme/siatex/css/rtl.css" rel="stylesheet" type="text/css" />
	<?php } ?>
	...
	<?php if(!($this->config->get('responsive_layout') == '1' && $this->config->get('general_status') == '1')) { ?>
		<?php if($dir == 'rtl') { ?>
		<link href="catalog/view/theme/siatex/css/responsive_rtl.css" rel="stylesheet" type="text/css" />
		<?php } else { ?>
		<link href="catalog/view/theme/siatex/css/responsive.css" rel="stylesheet" type="text/css" />
		<?php } ?>
	<?php } ?>
	...
	<![endif]--> 
	<!--[if IE 7]>
	<link rel="stylesheet" type="text/css" href="catalog/view/theme/siatex/css/ie7.css" />
	<![endif]-->
</head>
<body>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<header>
		...
		<div class="top set-size clearfix">
			...
			<div class="float-left"><a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $name; ?>" title="<?php echo $name; ?>" /></a></div>
			<?php } ?>
					...
					for ($i = 1; $i <= 6; $i++) { 
						...
						if(isset($slider[$i][$language_id]['status'])) {
							...
							if($slider[$i][$language_id]['status'] == '1') {
								...
								echo '<li data-transition="'.$slider[$i][$language_id]['transition_effect'].'" data-slotamount="10" data-masterspeed="300"'.$link.'><img src="image/'.$image.'" data-fullwidthcentering="on" alt ="'.strip_tags($description).'">'.$description.'</li>';
