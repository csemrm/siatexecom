            ...
            <table class="list">
                ...
                <tbody>
                    ...
                    <tr id="<?php echo $product['type'].$product['id']; ?>" class="edit_tr" >
                        ...
                        <div id="tips_meta_description_input_<?php echo $product['type'].$product['id']; ?>" class="mgt-serp-editor-tip"><b>Tip:</b> the maximum number of characters in a Google SERP snippet is 156. Current char.<span id="count_meta_description_input_<?php echo $product['type'].$product['id']; ?>" style="color: red"> </span></div>
                        </td>
                        <?php } else { ?>
                        <td class="left" style="background:lightgrey"></td>
                        <?php } ?>
