...
class ControllerCatalogSeoPack extends Controller {
    ...
    public function index() {
        ...
        if (!$exists) {
            $this->db->query("ALTER TABLE " . DB_PREFIX . "product_description ADD COLUMN `custom_h1` varchar(255) NULL DEFAULT '';");
        }
        ...
        if (!$exists) {
            $this->db->query("ALTER TABLE " . DB_PREFIX . "product_description ADD COLUMN `custom_alt` varchar(255) NULL DEFAULT '';");
        }
